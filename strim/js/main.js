$(document).ready(function () {
    ...
    //     },
    // });
    // $('.scroll-payment-js').scrollTop(460);
    function calcSize() {
        let heightStart = $('.container-info-about-strim-video .wrapper-wideo-players').height(),
            widthStart = $('.container-info-about-strim-video .wrapper-wideo-players').width();
    ...
    $('.cvv-card, .how-much, .add-new-info').bind("change keyup input", function () {
    ...
    pickerFixed1 = new Picker({
        ...
        onChange: function (color) {
            document.querySelector(".progress-line").style.backgroundColor = color.rgbaString;
        },
    });
    ...
    $(".close-status-link").click(function () {
        $(this).closest(".header-afisha").find('.wrapper-nick').removeClass("active-nicks");
        $(this).closest(".header-afisha").find('.wrapper-nick').addClass("active-nick");
    });
    $(".private-status-link").click(function () {
        $(this).closest(".header-afisha").find('.wrapper-nick').removeClass("active-nick");
        $(this).closest(".header-afisha").find('.wrapper-nick').addClass("active-nicks");
    });
    ...
    $(".edit-price-input").on('focus', function () {
        $(this).addClass('active-satus-price');
        $(this).closest('.list-info-translation').find('.free-status-price').removeClass('active-satus-price');
        $(this).closest('.list-item').addClass('scroll-auto');
    });
    $('.price-translation').on('click', function () {
        $(this).closest('.list-info-translation').find('.edit-time-end').slideDown();
    });
    ...
    $('.settings-btn').click(function () {
        $(this).closest('.footer-item-translation').addClass('active-questions-setting');
    });
    ...
    $('.yes-setting-item').click(function (event) {
        event.preventDefault();
        $(this).closest('.container-list-item').find('.header-afisha').addClass('fade-header-afisha');
        $(this).closest('.container-list-item').find('.fade-header-afisha').fadeOut(500);

        setTimeout(() => {
            $(this).closest('.container-list-item').find('.setting-afisha').fadeIn(500);
        }, 500);

        $(this).closest('.container-list-item').find('.footer-item-translation').addClass('toggle-out');
        $(this).closest('.container-list-item').find('.public-footer').addClass('active-publick-footer');
        $(this).closest('.container-list-item').find('.block-time-translation').fadeOut(500);
    });

    $('.close-public-change').on('click', function () {
        $(this).closest('.container-list-item').find('.header-afisha').removeClass('fade-header-afisha');
        ...
        $(this).closest('.container-list-item').find('.block-time-translation').fadeIn(500);
    });
    ...
    $('.redactor-video').on('click', function () {
        $(this).closest('.wrapper-stream-video').find('.container-video-strim').addClass('opacity-video');
        $(this).closest('.wrapper-stream-video').find('.container-setting-video-strim').fadeIn(500);
        $(this).fadeOut(500);
    });

    $('.save-edit-change').on('click', function () {
        $(this).closest('.wrapper-stream-video').find('.container-video-strim').removeClass('opacity-video');
        $(this).closest('.wrapper-stream-video').find('.container-setting-video-strim').fadeOut(500);
    ...
    $('.close-link').on('click', function () {
        setTimeout(() => {
            $(this).closest('.social-item').find('.wrapper-social-edit-btn').fadeIn(500);
        }, 500);
        $(this).closest('.social-item').find('.adress-link-input').fadeOut(500);
    });

    $('.title-change-password').on('click', function () {
        $(this).closest('.container-change-password').find('.form-change-password').slideToggle();
    });
    ...
    $('.edit-text-frame').on('click', function () {
        $(this).closest('.bottom-block-about-frame').find('textarea').prop('disabled', false);
    });
    ...
    $('.item-stream').on('click', function () {
        if ($('.wrapper-stream-content').hasClass('active-frame-height')) {
            ...
            $(this).closest('.content').find('.wrapper-about-frame').removeClass('active-frame');
            $(this).closest('.content').find('.wrapper-stream-content').removeClass('active-frame-height');
        } else {
    ...
    $('.start-translation').on('click', function (event) {
        event.preventDefault();
        $(this).closest('.container-stream').find('.wrapper-start-translation').slideToggle(500);
    });
    ...
    $('.notifications-link').on('click', function () {
        $(this).closest('.about-frame').find('.big-center-info').addClass('active-notifications');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-schedule');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-message-block');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-tickets');
    ...
    $('.message-link').on('click', function () {
        $(this).closest('.about-frame').find('.big-center-info').addClass('active-message-block');
    ...
    $('.schedule-link').on('click', function () {
        $(this).closest('.about-frame').find('.big-center-info').addClass('active-schedule');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-notifications');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-message-block');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-tickets');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-finance');
    ...
    $('.tickets-link').on('click', function () {
        $(this).closest('.about-frame').find('.big-center-info').addClass('active-tickets');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-schedule');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-notifications');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-message-block');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-finance');
    ...
    $('.finance-link').on('click', function () {
        $(this).closest('.about-frame').find('.big-center-info').addClass('active-finance');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-tickets');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-schedule');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-notifications');
        $(this).closest('.about-frame').find('.big-center-info').removeClass('active-message-block');
    ...
    $('.setting-stream').on('click', function () {
        ...
        $(this).closest('.wrapper-frame-content').find('.item-link-menu').removeClass('active-link');
        $(this).closest('.wrapper-frame-content').find('.wrapper-setting-game').addClass('active-game-list');

        $(this).closest('.wrapper-frame-content').find('.active-game-list').slideToggle(500, function () {
            if ($(this).is(':visible'))
    ...
    $('.rules').on('click', function (event) {
        event.preventDefault();
        $(this).closest('.container-stream').find('.regulations-block').slideToggle(500);
    });
    ...
    $('.pay-ticket').on('click', function () {
        $(this).closest('.footer-item-translation').find('.payment-tikets').slideToggle(800);
    });

    $('.participate').on('click', function () {
        $(this).closest('.footer-item-translation').find('.time-broadcast-tikets').slideToggle(800);
    });
